...
HD_PWD='/home/asautaux/yarr_sim/project_sim/project_sim2.runs/fifo_605x32_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_605x32.vds -m64 -mode batch -messageDb vivado.pb -notrace -source fifo_605x32.tcl
