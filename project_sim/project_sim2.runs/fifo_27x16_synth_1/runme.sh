...
HD_PWD='/home/asautaux/yarr_sim/project_sim/project_sim2.runs/fifo_27x16_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_27x16.vds -m64 -mode batch -messageDb vivado.pb -notrace -source fifo_27x16.tcl
