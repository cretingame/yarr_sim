...
HD_PWD='/home/asautaux/yarr_sim/project_sim/project_sim2.runs/fifo_4x16_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_4x16.vds -m64 -mode batch -messageDb vivado.pb -notrace -source fifo_4x16.tcl
