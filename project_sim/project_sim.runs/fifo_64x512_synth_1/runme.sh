...
HD_PWD='C:/cygwin64/home/saute/yarr_sim/project_sim/project_sim.runs/fifo_64x512_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_64x512.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_64x512.tcl
