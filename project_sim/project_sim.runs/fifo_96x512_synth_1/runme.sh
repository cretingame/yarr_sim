...
HD_PWD='C:/cygwin64/home/saute/yarr_sim/project_sim/project_sim.runs/fifo_96x512_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_96x512.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_96x512.tcl
