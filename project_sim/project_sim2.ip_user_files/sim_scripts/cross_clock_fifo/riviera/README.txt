...
switch to the './cross_clock_fifo.sh' script.

./cross_clock_fifo.sh -reset_run
...
./cross_clock_fifo.sh -noclean_files

For more information on the script, please type './cross_clock_fifo.sh -help'.
