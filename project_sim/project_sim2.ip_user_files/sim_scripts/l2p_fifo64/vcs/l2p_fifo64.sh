...
#
# Generated by Vivado on Wed Jul 05 09:01:18 PDT 2017
...
# executing this script. Please type 'l2p_fifo64.sh -help' for more information.
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.l2p_fifo64 xil_defaultlib.glbl -o l2p_fifo64_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./l2p_fifo64_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key l2p_fifo64_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc l2p_fifo64_simv.daidir)
