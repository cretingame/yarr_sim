...
#
# Generated by Vivado on Wed Jan 11 14:25:36 -0800 2017
...
# Script info
echo -e "fifo_32x512.sh - Script generated by export_simulation (Vivado v2016.4 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L fifo_generator_v13_1_3 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo_32x512 xil_defaultlib.fifo_32x512 xil_defaultlib.glbl -log elaborate.log
}
