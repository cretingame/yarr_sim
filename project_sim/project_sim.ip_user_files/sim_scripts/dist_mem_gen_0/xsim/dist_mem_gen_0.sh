...
#
# Generated by Vivado on Tue Feb 07 14:31:40 -0800 2017
...
# Script info
echo -e "dist_mem_gen_0.sh - Script generated by export_simulation (Vivado v2016.4 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L dist_mem_gen_v8_0_11 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dist_mem_gen_0 xil_defaultlib.dist_mem_gen_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim dist_mem_gen_0 -key {Behavioral:sim_1:Functional:dist_mem_gen_0} -tclbatch cmd.tcl -log simulate.log
}
